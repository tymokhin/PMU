...
#if (TRC_CFG_ACKNOWLEDGE_QUEUE_SET_SEND == TRC_ACKNOWLEDGED) && (TRC_CFG_FREERTOS_VERSION == TRC_FREERTOS_VERSION_10_4_0 || TRC_CFG_FREERTOS_VERSION == TRC_FREERTOS_VERSION_10_4_1) && (configUSE_QUEUE_SETS == 1)
#error "When using FreeRTOS v10.4.0 or v10.4.1, Back TRC_CFG_ACKNOWLEDGE_QUEUE_SET_SEND to 0 in trcConfig.h. This is my adding."
#endif /* (TRC_CFG_ACKNOWLEDGE_QUEUE_SET_SEND != TRC_ACKNOWLEDGED) && (TRC_CFG_FREERTOS_VERSION == TRC_FREERTOS_VERSION_10_3_0 || TRC_CFG_FREERTOS_VERSION == TRC_FREERTOS_VERSION_10_3_1) && (configUSE_QUEUE_SETS == 1) */
