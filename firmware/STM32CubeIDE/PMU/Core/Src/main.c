...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOE, ADC_IN1_Pin|ADC_IN2_Pin|ADC_IN4_Pin|ADC_IN3_Pin
                          |ADC_IN5_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOH, ADC_MODE2_Pin|ADC_MODE1_Pin|ADC_MODE0_Pin|ADC_PAR_SER_BYTE_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOC, GPS_RESET_Pin|GPS_PWR_ON_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOA, ANT_PWR_ON_Pin|LED_REST_Pin|GPS_SYNC_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOF, ADC_IN7_Pin|ADC_IN6_Pin|ADC_RESET_Pin|ADC_RANGE_Pin
                          |ADC_IN8_Pin, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(ETH_RST_IN_GPIO_Port, ETH_RST_IN_Pin, GPIO_PIN_SET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, DTR_Pin|USB_VBUS_EN_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : ADC_IN1_Pin ADC_IN2_Pin ADC_IN4_Pin ADC_IN3_Pin
                           ADC_IN5_Pin */
  GPIO_InitStruct.Pin = ADC_IN1_Pin|ADC_IN2_Pin|ADC_IN4_Pin|ADC_IN3_Pin
                          |ADC_IN5_Pin;
  ...
  /*Configure GPIO pins : ADC_MODE2_Pin ADC_MODE1_Pin ADC_MODE0_Pin ADC_PAR_SER_BYTE_Pin */
  GPIO_InitStruct.Pin = ADC_MODE2_Pin|ADC_MODE1_Pin|ADC_MODE0_Pin|ADC_PAR_SER_BYTE_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOH, &GPIO_InitStruct);

  /*Configure GPIO pins : RI_Pin DCD_Pin DSR_Pin ADC_FIRSTDATA_Pin
                           NET_ACT_Pin */
  GPIO_InitStruct.Pin = RI_Pin|DCD_Pin|DSR_Pin|ADC_FIRSTDATA_Pin
                          |NET_ACT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : GPS_RESET_Pin GPS_PWR_ON_Pin */
  GPIO_InitStruct.Pin = GPS_RESET_Pin|GPS_PWR_ON_Pin;
  ...
  /*Configure GPIO pins : ANT_PWR_ON_Pin LED_REST_Pin GPS_SYNC_Pin */
  GPIO_InitStruct.Pin = ANT_PWR_ON_Pin|LED_REST_Pin|GPS_SYNC_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOA, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : ADC_IN7_Pin ADC_IN6_Pin ADC_RESET_Pin ADC_RANGE_Pin
                           ADC_IN8_Pin */
  GPIO_InitStruct.Pin = ADC_IN7_Pin|ADC_IN6_Pin|ADC_RESET_Pin|ADC_RANGE_Pin
                          |ADC_IN8_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  ...
  /*Configure GPIO pin : SIM_PRESENT_Pin */
  GPIO_InitStruct.Pin = SIM_PRESENT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(SIM_PRESENT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : USB_VBUS_FAULT_Pin */
  GPIO_InitStruct.Pin = USB_VBUS_FAULT_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_INPUT;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(USB_VBUS_FAULT_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pin : ETH_RST_IN_Pin */
  GPIO_InitStruct.Pin = ETH_RST_IN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(ETH_RST_IN_GPIO_Port, &GPIO_InitStruct);

  /*Configure GPIO pins : DTR_Pin USB_VBUS_EN_Pin */
  GPIO_InitStruct.Pin = DTR_Pin|USB_VBUS_EN_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
