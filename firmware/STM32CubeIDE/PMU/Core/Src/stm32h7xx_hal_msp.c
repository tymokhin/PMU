...
void HAL_SD_MspDeInit(SD_HandleTypeDef* hsd)
{
  if(hsd->Instance==SDMMC2)
  {
    ...
    PA0     ------> SDMMC2_CMD
    */
    HAL_GPIO_DeInit(GPIOG, GPIO_PIN_10|GPIO_PIN_11|GPIO_PIN_9|GPIO_PIN_12);
...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  else if(htim->Instance==TIM4)
  {
    ...
    PD12     ------> TIM4_CH1
    */
    GPIO_InitStruct.Pin = ADC_CONVERT_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM4;
    HAL_GPIO_Init(ADC_CONVERT_GPIO_Port, &GPIO_InitStruct);
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  ...
  else if(htim_base->Instance==TIM5)
  {
    ...
    PH10     ------> TIM5_CH1
    */
    HAL_GPIO_DeInit(PPS_GPIO_Port, PPS_Pin);
...
static void HAL_FMC_MspInit(void){
  ...
  */
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_1|GPIO_PIN_7
                          |GPIO_PIN_0|GPIO_PIN_15|GPIO_PIN_14|GPIO_PIN_9
  ...
  GPIO_InitStruct.Pin = GPIO_PIN_1|GPIO_PIN_0|GPIO_PIN_7|GPIO_PIN_8
                          |GPIO_PIN_9|GPIO_PIN_14|GPIO_PIN_13|GPIO_PIN_10
...
static void HAL_FMC_MspDeInit(void){
  ...
  */
  ...
  HAL_GPIO_DeInit(GPIOD, GPIO_PIN_5|GPIO_PIN_4|GPIO_PIN_1|GPIO_PIN_7
                          |GPIO_PIN_0|GPIO_PIN_15|GPIO_PIN_14|GPIO_PIN_9
                          |GPIO_PIN_10|GPIO_PIN_8);
  ...
  HAL_GPIO_DeInit(GPIOC, GPIO_PIN_8|GPIO_PIN_2|GPIO_PIN_0|GPIO_PIN_3);
